...
// +kubebuilder:printcolumn:name="core used",type="string",JSONPath=".status.allocated.core",description="CORE"
// +kubebuilder:printcolumn:name="memory used",type="string",JSONPath=".status.allocated.memory",description="MEMORY USED"
